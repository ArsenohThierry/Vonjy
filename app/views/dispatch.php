...
<body>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
                ...
                <?php if (!empty($simulated)): ?>
                    ...
                    <?php if (!empty($modeDispatch)): ?>
                        <span class="simulation-badge" style="background: #e3f2fd; color: #1565c0; margin-left: 10px;">
                            Mode : <?= $modeDispatch === 'date' ? 'Par date (ancienneté)' : 'Petit à petit (plus petits besoins)' ?>
                        </span>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if (!empty($canDistribute)): ?>
                    <!-- Bouton pour ouvrir le modal de distribution -->
                    <button type="button" class="btn-simulation" style="background: #27ae60;" onclick="openModeModal('distribuer')">
                        <svg class="btn-icon" viewBox="0 0 24 24" width="20" height="20">
            ...
            <div id="modeModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; justify-content: center; align-items: center;">
                <div style="background: white; border-radius: 12px; padding: 30px; max-width: 500px; width: 90%; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
                    <h3 style="margin: 0 0 20px; color: #333; font-size: 1.2em; display: flex; align-items: center; gap: 10px;">
                        <svg viewBox="0 0 24 24" width="24" height="24">
                            <path fill="#137C8B" d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/>
                        </svg>
                        Choisir le mode de dispatch
                    </h3>
                    <p style="color: #666; margin-bottom: 20px; font-size: 0.9em;">Sélectionnez l'ordre de priorité pour la répartition des dons :</p>
                    
                    <form id="modeForm" method="POST" action="">
                        <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 25px;">
                            <!-- Mode 1 : Par date -->
                            <label style="display: flex; align-items: flex-start; gap: 12px; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; cursor: pointer; transition: all 0.2s;" 
                                   onmouseover="this.style.borderColor='#137C8B'" onmouseout="this.style.borderColor=document.getElementById('mode_date').checked ? '#137C8B' : '#e0e0e0'">
                                <input type="radio" name="mode" id="mode_date" value="date" checked style="margin-top: 3px;">
                                <div>
                                    <strong style="color: #333;">📅 Par date (ancienneté)</strong>
                                    <p style="margin: 5px 0 0; color: #666; font-size: 0.85em;">
                                        Les besoins les plus anciens sont servis en premier. L'ordre est basé sur la date de saisie.
                                    </p>
                                </div>
                            </label>
                            ...
                            <label style="display: flex; align-items: flex-start; gap: 12px; padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; cursor: pointer; transition: all 0.2s;"
                                   onmouseover="this.style.borderColor='#137C8B'" onmouseout="this.style.borderColor=document.getElementById('mode_petit').checked ? '#137C8B' : '#e0e0e0'">
                                ...
                                <div>
                                    ...
                                    <p style="margin: 5px 0 0; color: #666; font-size: 0.85em;">
                                        Les villes avec les besoins les plus petits sont servis en premier. Permet de couvrir plus de villes.
                                    </p>
                                </div>
                            </label>
                        </div>
                        ...
                        <div style="display: flex; gap: 10px; justify-content: flex-end;">
                            <button type="button" onclick="closeModeModal()" style="padding: 10px 20px; border: 1px solid #ccc; background: white; border-radius: 6px; cursor: pointer; font-size: 0.9em;">
                                Annuler
                            </button>
                            <button type="submit" style="padding: 10px 20px; background: #137C8B; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 0.9em; font-weight: 600;">
                                Confirmer
                            </button>
                        </div>
                    </form>
