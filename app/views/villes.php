                        ...
                        foreach ($villes as $ville) { ?>
                            ...
                            <td>
                                <div class="ville-info">
                                    <span class="ville-nom"><?= $ville['ville'] ?></span>
                                    <span class="ville-code"><?= strtoupper(substr($ville['ville'], 0, 3)) ?></span>
                                </div>
                            </td>
                            <td><?= $ville['region'] ?></td>
                            <td>
                                <span class="badge"><?= $ville['nombre_besoins'] ?> besoins</span>
                            </td>
                            <td>
                                <span class="montant"><?= number_format($ville['total_estime_ar'], 0, ',', ' ') ?></span>
