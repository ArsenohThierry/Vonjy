...
$app->set('flight.base_url', '/ETU004031/ETU004031_ETU004183_ETU004273/Vonjy_Vaovao',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
return [
	...
	'database' => [
	 ...
	 'dbname'   => 'vonjy',   // Database name (e.g., 'flightphp')
	 'user'     => 'vonjy',  // Database user (e.g., 'root')
	 'password' => 'vonjy',  // Database password (never commit real passwords)
